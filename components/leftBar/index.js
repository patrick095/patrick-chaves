  ...
  function toogleNotification(){
    ...
    return (
        <div className={styles.left}>
            ...
            <Image src={profileImg} width={175} height={175} alt="profile-image" />
            <div 
          ...
          <div className={styles.coding}>
            <h2>Coding (<a title="Github" href="https://github.com/patrick095" target="_blank"  rel="noreferrer noopner" className={styles.contactIcons}>Github</a>)</h2>
          ...
          <div className={styles.downloadCV}>
            ...
            <a href="https://drive.google.com/file/d/1k93HCxIGKdQiAmHqP5ETTEi_8YoA-UJX/view?usp=sharing" target="_blank" rel="noreferrer noopner">
              <h2>Download CV <CloudDownloadIcon /></h2>
            </a>
          </div>
          <div className={styles.contact}>
          <a title="Github" href="https://github.com/patrick095" target="_blank" rel="noreferrer noopner" className={styles.contactIcons}>
          ...
          <a title="Linkedin" href="https://www.linkedin.com/in/patrick095/" target="_blank" rel="noreferrer noopner" className={styles.contactIcons}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-2 16h-2v-6h2v6zm-1-6.891c-.607 0-1.1-.496-1.1-1.109 0-.612.492-1.109 1.1-1.109s1.1.497 1.1 1.109c0 .613-.493 1.109-1.1 1.109zm8 6.891h-1.998v-2.861c0-1.881-2.002-1.722-2.002 0v2.861h-2v-6h2v1.093c.872-1.616 4-1.736 4 1.548v3.359z"/></svg>
          </a>
          <a title="Telegram" href="https://t.me/patrick095" target="_blank" rel="noreferrer noopner" className={styles.contactIcons}>
          ...
          <a title="Email" href="mailto:patrick095@gmail.com" target="_blank" rel="noreferrer noopner" className={styles.contactIcons}>
